    ...
    <div className="max-w-5xl mx-auto px-8 py-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[16rem_1fr] gap-6">
        ...
        <div className="card overflow-hidden h-fit">
          <div className="px-4 py-2.5 border-b border-gray-100 bg-gray-50 text-xs font-semibold text-gray-600 uppercase tracking-wider">
            XSD Files
          </div>
          {isPending ? (
            ...
            <div className="divide-y divide-gray-50">
              {schemas.map((s) => {
                ...
                return (
                  ...
                  >
                    <FileCode2
                      className={`w-4 h-4 flex-shrink-0 ${isActive ? 'text-coco-red' : 'text-gray-500'}`}
                    />
                    <span
        ...
        <div className="space-y-4 min-w-0">
          {!selected ? (
            <div className="card p-12 text-center">
              ...
              <p className="text-sm text-gray-500 font-medium">Select a schema to view it</p>
